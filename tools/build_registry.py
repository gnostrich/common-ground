...
MAP: dict[str, dict] = {
    ...
    "OI-4":  {"C": ["tests/test_constants_sweep.py:EveryEngineConstantCLAIMSAProvenance",
              ...
              "E": ["engine/constants_sweep.py", "seed/CONSTANT_PROVENANCE.json",
                    "engine/aging.py"]},
    "OI-5":  {"C": ["tests/test_conditionals.py:ThePlantedArmCarriesTheWeight",
                    "tests/test_conditionals.py:QuotingIsNotAsserting",
                    "tests/test_conditionals.py:TheREALNormativeTextIsClean",
                    "tests/test_conditionals.py:TheExemptionIsANamedLineNotACategory"],
              "E": ["engine/conditionals.py:findings", "engine/conditionals.py:TELLS"]},
    ...
    "OI-30": {"C": ["tests/test_decompose.py:TheRemainderIsALWAYSNamed",
                    "tests/test_decompose.py:OI24LivesInsideOI30",
                    "tests/test_decompose.py:TheJournalNAMESWhatItsCallsDid",
                    "tests/test_decompose.py:PlantedAbsorption"],
              "E": ["engine/decompose.py:decompose", "engine/decompose.py:attributed",
                    "engine/journal.py"]},
